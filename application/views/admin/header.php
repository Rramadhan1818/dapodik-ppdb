...
<head>
	...
	<link rel="icon" type="image/png" href="assets/panel/images/logosmkneja.png">
...
<body class="navbar-bottom">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="">PPDB <label class="label label-primary">SMKN Jatiluhur</label></a>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_admin/profile" class="media-left"><img src="assets/panel/images/logoneja.png" class="img-circle img-sm" alt="foto"></a>
