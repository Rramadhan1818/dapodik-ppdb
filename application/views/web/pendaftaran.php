...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logoneja.png" type="image/png">
    <title>PPDB SMK Negeri JATILUHUR</title>
            ...
            <div class="col-sm-12">
              ...
              <h2>
								<strong class="text-primary">
									<a href=""><img src="img/logosmkneja.png" alt="Logo" width="30" style="position:absolute;margin-top:-8px;"> <span style="margin-left:35px;color:#fff;">PPDB SMK Negeri Jatiluhur</span></a>
								</strong>
							</h>
              </div>
            </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> SMK Negeri Jatiluhur</strong></h2>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SMKN Jatiluhur hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="#" target="_blank">SMKN Jatiluhur</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
