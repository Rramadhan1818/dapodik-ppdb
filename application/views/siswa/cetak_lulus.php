...
<html>
  <head>
    ...
    <base href="<?php echo base_url();?>"/>
  	<link rel="icon" type="image/png" href="assets/images/logoneja.png"/>
    <style>
    table {
  ...
  <body onload="window.print();">
    ...
    <table width="100%" border="0">
      <tr>
        <td colspan="3">Kepala SMK Negeri Jatiluhur dengan ini menyatakan bahwa :</td>
      </tr>
      <tr>
    ...
    Seleksi Sebagai Calon Peserta Didik SMK Negeri Jatiluhur tahun ajaran <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb+1; ?>.<br>
    Demikian pengumuman ini disampaikan untuk dapat digunakan sebagai mestinya.
    <br><br>

    <div style="float:right;">
      Purwakarta, <?php echo date('Y'); ?> <br>
			Kepala Sekolah,  <br>
      <br>
      <center>dto</center>
      <b><u>Dudi Setiadi, S.Pd</u></b><br>
      NIP. -
    </div>
    <br><br><br><br><br><br>
