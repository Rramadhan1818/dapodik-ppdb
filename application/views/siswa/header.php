...
<head>
	...
	<title>SMK Negeri Jatiluhur</title>
	<link rel="icon" type="image/png" href="assets/panel/images/logoneja.png">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="assets/panel/images/logoneja.png" alt="foto">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="assets/panel/images/logoneja.png" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="files/Panduan_PPDB_Online_SMKNJatiluhur.pdf"><i class="icon-file-download2"></i> <span>Download Panduan</span></a></li>
