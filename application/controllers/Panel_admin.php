...
class Panel_admin extends CI_Controller {
	...
	{
		$ceks = $this->session->userdata('admin');
		if(!isset($ceks)) {
								 ...
								 redirect('panel_admin/log_in');
										 ...
										 if($cekpass <> $pass) {
												...
												redirect('panel_admin/log_in');
																...
																$this->session->set_userdata('admin', "$cekun");
			...
			$data['judul_web'] 		= "Profile";
					...
					if (isset($_POST['btnupdate'])) {
						...
						$nama_lengkap	= $this->input->post('nama_lengkap');
									...
									$this->session->has_userdata('admin');
	...
	public function logout() {
     if ($this->session->has_userdata('admin') != '' AND $this->session->has_userdata('id_user@sman1_belitang') != '') {
